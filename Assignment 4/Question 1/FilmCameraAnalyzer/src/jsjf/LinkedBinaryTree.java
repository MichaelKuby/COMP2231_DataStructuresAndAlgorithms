...
public class LinkedBinaryTree<T> implements BinaryTreeADT<T>, Iterable<T>
{
	...
	{
		// Base case 1: current node is set to null
		if (next == null)
			return null;

		// Base case 2: current node contains a reference to target element
		...
		// by now the target element will have either been found
		// and stored in temp, or all returns for temp will be null
		return temp;
	}
