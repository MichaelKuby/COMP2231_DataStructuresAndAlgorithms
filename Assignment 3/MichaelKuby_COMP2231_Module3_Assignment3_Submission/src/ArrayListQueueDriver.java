...
/**
 * ArrayListQueueDriver employs the methods of the ArrayListQueue class,
...
public class ArrayListQueueDriver
{
    ...
    {
        //-----------------------------------------------------------------
        // Create a queue using an ArrayListQueue collection object,
        // add a variety of elements, and test each method.
        //-----------------------------------------------------------------
        QueueADT<String> queue = new ArrayListQueue<>();
        ...
        Iterator<String> itr = ((ArrayListQueue<String>) queue).iterator();
        while (itr.hasNext())
        {
